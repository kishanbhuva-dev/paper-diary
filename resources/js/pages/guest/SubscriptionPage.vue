<template>
  <main class="bg-gray-50 min-h-screen">
    ...
    <div
      v-else
      class="container mx-auto px-4 py-8 sm:py-12 sm:px-6 lg:px-8"
    >
      <div
          ...
          <div class="flex-grow">
            ...
            <ul class="mt-8 space-y-4 text-sm text-gray-600">
              ...
              <li class="flex items-start">
                ...
                <span v-else-if="plan.recurring?.interval === 'year'"
      ...
      <div
        v-if="selectedPlanDetails"
        class="mt-4 sm:mt-8 max-w-4xl mx-auto"
      >
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
          <div
            class="border-b border-gray-200 px-4 py-4 sm:px-8 sm:py-6 grid grid-cols-3 items-center"
          >
            ...
            <div class="text-center">
              ...
              <p class="text-gray-500 text-[10px] sm:text-sm mt-0.5 hidden sm:block">
          ...
          <div
            class="px-4 py-4 sm:px-8 sm:py-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200"
          >
          ...
          <form
            class="px-4 py-6 sm:px-8 sm:py-8 space-y-5 sm:space-y-6"
            @submit.prevent="handleSubscriptionPayment"
          >
            <div>
              <label
                class="block text-xs sm:text-sm font-bold text-gray-700 mb-1.5 uppercase tracking-wide"
              >
                Cardholder Name
              </label>
              <div class="relative">
            ...
            <div>
              ...
              <p
                id="card-errors"
                role="alert"
                class="mt-2 text-[11px] sm:text-xs text-red-500 font-medium"
              ></p>
            </div>
