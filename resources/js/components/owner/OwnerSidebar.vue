        ...
        <aside :class="[
                ...
                <div class=" border-indigo-200 border-b h-18 py-2 px-4">
                        <div class="flex items-center justify-between ">
                                <span class="text-lg font-bold tracking-wide text-indigo-700">PAPER DIARY</span>
                ...
                <ul class="flex-1 overflow-y-auto">
                        <li v-for="item in mainMenuItems" :key="item.name">
                                ...
                                <RouterLink :to="item.to"
                                        ...
                                        :class="{ 'bg-indigo-100 text-indigo-800 font-semibold': $route.name === item.name }"
                ...
                <div class="p-2 border-t border-indigo-200">
                        <button @click="handleLogout"
                                ...
                                <Icon icon="mdi:logout" class="text-2xl min-w-[2rem] transition-colors duration-300" />
                                <span class="ml-3 text-md font-medium whitespace-nowrap">
                                        Logout
                                </span>
                        </button>
                </div>
...
const mainMenuItems = [
        { name: "owner-dashboard", label: "Dashboard", icon: "mdi:view-dashboard-outline", to: { name: "owner-dashboard" } },
        { name: "properties", label: "Properties", icon: "mdi:home-city-outline", to: { name: "properties" } },
];
